# Generated by Django 4.0 on 2021-12-28 01:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 caracteres Caracteres <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>', max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Ingrese el nombre del genero (p. ej. Ciencia Ficcion, Poesia Francesa etc.)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
